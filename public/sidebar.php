...
<html lang="en" class="no-js">
	...
	<body class="cbp-spmenu-push">
		<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1" style="overflow: scroll; ">
			<h3  style="background-color: white; color: black; font-family: 'Muli', sans-serif;  ">Categories <button id="showLeftPush1t">Close</button></h3>


			<p style="  background-color: #333333;  font-family: 'Muli', sans-serif;"><a href="all_products.php"  style=" color: black;"  ><strong> ALL PROJECTS </strong></a></p>
