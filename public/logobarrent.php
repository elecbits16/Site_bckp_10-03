...
<nav class="navbar navbar-default hidden-xs hidden-sm hidden-md " style="background-color: white; " >
  <div class="container">
    ...
    <div  style="background-color: white; ">
      ...
      <li><a href="" style="padding:30px 0px 0px 10px; font-family: 'Muli', sans-serif; float:left; color:black; "><strong>&nbsp(Coming Soon with more options)</strong> </a></li>
...
<form class="searchbox"  method="get" action="results.php"  enctype="multipart/form-data"  >
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color: white; padding: 10px 0px 0px 40px; ">
      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li> <a href="rent.php" style="padding-left: 20px; "><span id="g2" class="glyphicon glyphicon-bookmark" style="vertical-align: text-top; padding-right:10px;"></span>&nbspRent</a> </li>
      <li> <a href="need_project.php" style="padding-left: 20px; "><span id="g2" class="glyphicon glyphicon-bookmark" style="vertical-align: text-top; padding-right:10px;"></span>&nbspRequest Project</a> </li>
