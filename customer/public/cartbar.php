...
<html lang="en" class="no-js">
	...
	<body class="cbp-spmenu-push">
     ...
     if (!isset($_SESSION['customer_email'])) {
       ...
       echo "
       <br><p style='padding: 0px 0px 0px 10px;'><span class='glyphicon glyphicon-user' style='vertical-align: text-top; padding-right:10px;  font-family: 'Muli', sans-serif;'> </span>Hi Guest</p>" ; 
     ...
     else
     {
      ...
      $run_name_query = mysql_query($con, $name_query);
    ...
    <?php
     ...
     else
     {
      ...
      echo "
      <br><br><p style='padding: 0px 0px 0px 10px;' ><span class='glyphicon glyphicon-user' style='vertical-align: text-top;  padding-right:10px; font-family: 'Muli', sans-serif; '> </span><a href='my_account.php'>Hi $customer_name</a></p>";    

       echo "<a href='logout.php' style='padding:0px 0px 0px 10px;  font-family: 'Muli', sans-serif;'>Logout</a> ";
  ...
  <div class="panel panel-default hidden-xs" >
    ...
    <div class="panel-body">
      ...
      <div class= "col-lg-4 col-xs-12"  style="border-style: solid;  border-color: grey ; padding: 20px 20px 30px 20px ; "  >
        ...
        <img src="C:/wamp/www/maintest/admin_area/product_img<?php echo $product_image ;?>" width="180" height = "200" />
    ...
    <div class="panel panel-default">
      <div class="panel-heading" style="background-color: #0070FF; border-style: solid; border-color:  #0070FF; ">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse65" style="color: white; ">Checkout </a>
        </h4>
      </div>
...
<span   ><a href="../checkout.php">Let's Go</a> </span>
<br>
