...
<h3 style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px; text-align: center; ">INSERT C++ POSTS</h3>
...
if ( (isset($_POST['insert_post'])) || (isset($_FILES['uploadedfile']) )) {
  //getting the text data
   ...
   $insert_Post = "INSERT INTO post (post_id , post_title, m_category, category, sub_category  , code, author_name, author_face, author_linkedIn, author_image,author_youtube , post_keywords) VALUES ('$Post_id','$Post_title','C++',  '$Post_cat','$sub_category', '$code' , '$author_name', '$author_face', '$author_linkedIn', '$author_image', '$author_youtube','$post_keywords') ";
