...
<h3 style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px; text-align: center; ">INSERT ANDROID POSTS</h3>
...
<tr>
    ...
    <td> <select name="m_category" disabled/>
...
-->
  ...
  <tr>
      <td>Code snippet</td>
    <td> <textarea name="code_s"  cols="20" rows="10"></textarea> </td> 
  </tr>
...
if ( (isset($_POST['insert_post'])) || (isset($_FILES['uploadedfile']) )) {
   ...
   $insert_Post = "INSERT INTO post (post_id , post_title, m_category, category, sub_category  , code, author_name, author_face, author_linkedIn, author_image,author_youtube , post_keywords) VALUES ('$Post_id','$Post_title','Android',  '$Post_cat','$sub_category', '$code' , '$author_name', '$author_face', '$author_linkedIn', '$author_image', '$author_youtube','$post_keywords') ";
...
if (mysql_query($insert_Post, $con)) {
    ...
    echo "<script>window.open('index.php?view_products_android','_self')</script>";
} else {
