...
<!-- Readymade project form -->
  ...
  <form class="cbp-mc-form" method="post" action="">
    ...
    <input type="text" id="first_name" name="clientName1" required/>
    
    <label for="email">Email Address</label>
    <input type="email" id="email" name="mailid1" required/>
    
     <label >Select range</label>
    <md-select name="range1" ng-model="range1" class="md-no-underline" required/>       
       <md-option value="0-3999">0-3999 </md-option>
       <md-option value="4000-6999">4000-6999</md-option>
       <md-option value="7000-9999" >7000-9999</md-option>
       <md-option value="10,000-Above" >10,000-Above </md-option> 
...
<div class="col-lg-6">
  <label for="phone">Phone Number</label>
    <input type="text" id="phone" name="contact1"  required/>


    <label for="phone">Your Location </label>
       <md-select name="loc1" ng-model="loc1" class="md-no-underline" required>
                      <md-option value="New Delhi">New Delhi</md-option>
                      ...
                      <md-option value="Gurgaon">Gurgaon</md-option>
                                            ...
                                            <md-option value="Outside NCR">Outside NCR</md-option>
                    </md-select>

<label>Choose a deliver date  <span style="font-size: 13px;"> (Closest date would be <?php echo date('d-m-Y', strtotime("+2 day")); ?>)</span> : </label>
<input type="date"  name="ddate1" min='<?php echo date('Y-m-d', strtotime("+2 day")); ?>' required/>
...
<label for="phone">Project Title </label>
    <input type="text" id="phone" name="title1" required/>


    <label for="affiliations"> Short Description</label>
    <textarea id="affiliations" name="desc1" required/></textarea>
