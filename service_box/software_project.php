...
<p style="font-weight: 800;">SOFTWARE PROJECTS</p>
...
<label>Select Services :</label>
     ...
     <div class="radio">
  <label><input type="radio" name="loc" required value="Xilinx">Xilinx</label>
</div>

<div class="radio">
  <label><input type="radio" name="loc" value="MATLAB">MATLAB</label>
</div>

<div class="radio ">
  <label><input type="radio" name="loc" value="Big Data">Big Data</label>
</div>
<div class="radio ">
