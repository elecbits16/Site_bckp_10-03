...
<p style="font-weight: 800;">SELL YOUR PROJECT</p>
...
<form method="post" action="">
 ...
 <div layout-gt-xs="row">
         ...
         <div flex-gt-xs>
          ...
          <p style="margin:0px">Pickup Date</p> <span style="font-size: 15px;"> (Closest date would be <?php echo date('d-m-Y', strtotime("+3 day")); ?>)</span>
          <br> <br>
...
<label>Project Condition :</label>
     <div class="radio">
  <label><input type="radio" name="range"  required  value="Working">Working </label> 
       
</div>

<div class="radio">
  <label><input type="radio" name="range" value="Partially Working">Partially Working</label>
</div>

<div class="radio ">
  <label><input type="radio" name="range"  value="Non- working" >Non- working</label>
</div>
...
<label>Pickup Location:</label>
     ...
     <div class="radio">
  <label><input type="radio" name="loc" required value="south delhi">South Delhi</label>
</div>

<div class="radio">
  <label><input type="radio" name="loc" value="west delhi">West Delhi</label>
</div>
...
<br>
  <div layout-gt-lg="row">
        <md-input-container class="md-block">
          <label>Project Description (Provide complete details )</label>
