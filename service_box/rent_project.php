...
<p style="font-weight: 800;">RENT A PROJECT</p>
...
<div class="radio">
  <label><input type="radio" name="ploc" required value="South Delhi">South Delhi</label>
</div>

<div class="radio ">
  <label><input type="radio" name="ploc" value="West Delhi">West Delhi</label>
</div>
...
<label>Choose Rental Plan:</label>

  
<div class="radio">
  <label><input type="radio" name="rplan" required value="plan1">1 day - Get a project for a day at ₹ 600 - ₹ 1000 (Depending on the project.)</label>
</div>

<div class="radio ">
  <label><input type="radio" name="rplan" value="plan2">1 week - Get a project for a week at ₹ 1000 - ₹ 2000 (Depending on the project.)</label>
</div>
<div class="radio ">
  <label><input type="radio" name="rplan" value="plan3">1 month - Get a project for a month (Security money and deductions later on.)</label>
</div>
...
// echo  "$ip, $name, $sys, $mailid, $contact1, $loc , $rplan, $ploc,  $ddate1, $title1 ,  $desc, $promocode ";

   $msg = "$ip , $name, $sys, $mailid, $contact1, $loc , $rplan, $ploc,  $ddate1, $title1 ,  $desc, $promocode ";
