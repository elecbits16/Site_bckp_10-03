...
<p style="font-weight: 800;">INDUSTRIAL PROTOTYPES</p>
...
<label>Select Services :</label>
     ...
     <div class="radio">
  <label><input type="radio" name="loc" required value="Robotics">Robotics Prototype</label>
</div>

<div class="radio">
  <label><input type="radio" name="loc" value="Raspberry Pi Prototype">Raspberry Pi Prototype</label>
</div>

<div class="radio ">
  <label><input type="radio" name="loc" value="IOT Prototypes">IOT Prototypes</label>
</div>
<div class="radio ">
  <label><input type="radio" name="loc" value="Other services">Other services</label>
</div>
