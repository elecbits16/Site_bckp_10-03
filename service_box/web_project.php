...
<p style="font-weight: 800;">WEB PROJECTS</p>
...
<div class="col-lg-6">
<label>Select Service : <a href="http://web.elecbits.in/" target="_blank">(Click here to know more)</a> </label>

     <div class="radio">
  <label><input type="radio" name="loc" required value="Frontend Websites">Frontend Websites</label>
</div>

<div class="radio">
  <label><input type="radio" name="loc" value="Admin controlled website">Admin controlled website</label>
</div>

<div class="radio ">
  <label><input type="radio" name="loc" value="Wordpress">Wordpress</label>
</div>
<div class="radio ">
  <label><input type="radio" name="loc" value="Other Services(API)">Other Services(API)</label>
</div>
