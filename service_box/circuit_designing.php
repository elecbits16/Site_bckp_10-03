...
<p style="font-weight: 800;">CIRCUIT DESIGNING</p>
...
<label>Select Service :</label>
     <div class="radio">
  <label><input type="radio" name="range"   value="PCB designing">PCB designing  </label> 
       
</div>

<div class="radio">
  <label><input type="radio" name="range" value="PCB designing and implementation on board">PCB designing and implementation on board </label>
</div>

<div class="radio ">
  <label><input type="radio" name="range"  value="Schematic, block diagram and PCB designing" >Schematic, block diagram and PCB designing</label>
</div>

<div class="radio ">
  <label><input type="radio" name="range"  value="Other services" >Other services </label>
</div>
   </div>
