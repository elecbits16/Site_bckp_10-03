...
<p style="font-weight: 800;">NEED A STARTER KIT</p>
...
<label>Select Services : <a href="http://elecbits.in/elecd.php"  target="_blank">(Click here to know more)</a></label>
     <div class="radio">
  <label><input type="radio" name="range"   value=" Un">Elecduino Un  </label> 
       
</div>

<div class="radio">
  <label><input type="radio" name="range" value="Duex">Elecduino Duex </label>
</div>

<div class="radio ">
  <label><input type="radio" name="range"  value="Trios" >Elecduino Trios</label>
</div>
