...
<p style="font-weight: 800;">BUY COMPONENTS</p>
...
<br>
  <div layout-gt-lg="row">
        <md-input-container class="md-block">
          <label>Components Description (Please mention the component names and their required quantities)</label>
...
//echo  "$ip, $name, $sys, $mailid, , $contact1, $loc ,  $ddate1 ,  $desc , $promocode ";

   $msg = "$ip, $name, $sys, $mailid,  $contact1,   $loc,  $ddate1, $desc, $promocode ";
