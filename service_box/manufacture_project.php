...
<p style="font-weight: 800;">MANUFACTURE A PROJECT</p>
...
<label>Select plan :</label>
     <div class="radio">
  <label><input type="radio" name="range"   value="Just the code">Just the code </label> 
       
</div>

<div class="radio">
  <label><input type="radio" name="range" value="Code and integration with hardware">Code and integration with hardware </label>
</div>

<div class="radio ">
  <label><input type="radio" name="range"  value="Components, Code and integration with hardware" >Components, Code and integration with hardware</label>
</div>

<div class="radio ">
  <label><input type="radio" name="range"  value="Design manual, reports and intergration services." >Design manual, reports and intergration services. </label>
</div>
   </div>
